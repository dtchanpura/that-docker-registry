var app = (function () {
	...
	function create_if_block$1(component, ctx) {
		var td0, text0_value = ctx.tag.repositoryName, text0, text1, td1, code, text2_value = ctx.tag.tagName, text2, text3, td2, text4_value = ctx.tag.createdAt, text4;
		...
		return {
			...
			p: function update(changed, ctx) {
				...
				if ((changed.tag) && text4_value !== (text4_value = ctx.tag.createdAt)) {
	...
	function create_main_fragment$3(component, ctx) {
		var button, span0, text0, text1, table, thead, tr, th0, text3, th1, text4, span1, text5, th2, text6, span2, text7, tbody, current_block_type_index, if_block, current;
	...
	function create_else_block$2(component, ctx) {
		...
		return {
			c: function create() {
				...
				td2 = createElement("td");
				text4 = createText(text4_value);
				addLoc(td0, file$3, 20, 6, 773);
				addLoc(code, file$3, 21, 10, 808);
				addLoc(td1, file$3, 21, 6, 804);
				addLoc(td2, file$3, 22, 6, 836);
				addLoc(tr, file$3, 19, 4, 762);
			},
	...
	function create_main_fragment$4(component, ctx) {
		var title_value, text0, div5, div2, div0, h10, text1, text2, div1, h11, text3, text4, div3, current_block_type_index, if_block, text5, div4, text6, code0, text7, text8, code1, text9, current;
		...
		return {
			c: function create() {
				...
				addLoc(code0, file$4, 24, 19, 646);
				addLoc(code1, file$4, 25, 13, 682);
				div4.className = "row";
				addLoc(div4, file$4, 23, 1, 609);
				div5.className = "container";
				addLoc(div5, file$4, 4, 0, 57);
			},
