var app = (function () {
	...
	function create_if_block$1(component, ctx) {
		var td0, text0_value = ctx.tag.repositoryName, text0, text1, td1, code0, text2_value = ctx.tag.tagName, text2, text3, td2, code1, text4_value = ctx.tag.imageID.substr(7,12), text4, td2_title_value, text5, td3, text6_value = ctx.tag.createdAt, text6;
		...
		return {
			...
			p: function update(changed, ctx) {
				...
				if ((changed.tag) && text6_value !== (text6_value = ctx.tag.createdAt)) {
